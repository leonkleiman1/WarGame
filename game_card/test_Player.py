...
class TestPlayer(TestCase):
    ...
    def test_set_hand_valid(self, mock_deal_one):
        self.player_dan_15.set_hand(self.deck)
        self.assertEqual(15, len(self.player_dan_15.cards_player))
        self.assertIn(Card(1, 4), self.player_dan_15.cards_player)
        # check default num_per_player
        player = Player("name")
        player.set_hand(self.deck)
        self.assertEqual(26, len(player.cards_player))
    ...
    def test_get_card_valid(self):
        self.player_dan_15.cards_player.append(Card(1, 4))
        self.player_dan_15.cards_player.append(Card(2, 4))
